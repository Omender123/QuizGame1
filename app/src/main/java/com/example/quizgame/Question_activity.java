...
public class Question_activity extends AppCompatActivity {
        ...
        bookmarks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (modelMatch()) {
                    ...
                    Toast.makeText(Question_activity.this, "Remove Successful in Bookmark", Toast.LENGTH_SHORT).show();
                } else {
                    bookmarklist.add(list.get(position));
                    bookmarks.setImageDrawable(getDrawable(R.drawable.ic_bookmarkbtn_black_24dp));
                    Toast.makeText(Question_activity.this, "Add Successful in Bookmark", Toast.LENGTH_SHORT).show();
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position == list.size()) {
                    Intent scores = new Intent(Question_activity.this, Score_Activity.class);
    ...
    private void computer() {
        String computer1 = getIntent().getStringExtra("computer");
        switch (computer1) {
            case "0":
                question = getResources().getStringArray(R.array.basic_QuestionSet1);
                ...
                answer = getResources().getStringArray(R.array.answer_set1);
                for (int i = 0; i < 50; i++) {
            ...
            case "1":
                question = getResources().getStringArray(R.array.basic_QuestionSet2);
                option_a = getResources().getStringArray(R.array.option_a1);
                option_b = getResources().getStringArray(R.array.option_b1);
                option_c = getResources().getStringArray(R.array.option_c1);
                option_d = getResources().getStringArray(R.array.option_d1);
                answer = getResources().getStringArray(R.array.answer_set2);
                for (int i = 0; i < 50; i++) {
                    list.add(new Question_model(question[i], option_a[i], option_b[i], option_c[i], option_d[i], answer[i]));
                }
                break;
            case "2":
                question = getResources().getStringArray(R.array.basic_QuestionSet3);
                option_a = getResources().getStringArray(R.array.option_a2);
                option_b = getResources().getStringArray(R.array.option_b2);
                option_c = getResources().getStringArray(R.array.option_c2);
                option_d = getResources().getStringArray(R.array.option_d2);
                answer = getResources().getStringArray(R.array.answer_set3);
                for (int i = 0; i < 40; i++) {
                    list.add(new Question_model(question[i], option_a[i], option_b[i], option_c[i], option_d[i], answer[i]));
                }
                break;
            case "3":
                question = getResources().getStringArray(R.array.basic_QuestionSet4);
                option_a = getResources().getStringArray(R.array.option_a3);
                option_b = getResources().getStringArray(R.array.option_b3);
                option_c = getResources().getStringArray(R.array.option_c3);
                option_d = getResources().getStringArray(R.array.option_d3);
                answer = getResources().getStringArray(R.array.answer_set4);
                for (int i = 0; i < 50; i++) {
                    list.add(new Question_model(question[i], option_a[i], option_b[i], option_c[i], option_d[i], answer[i]));
                }
                break;
            ...
            case "4":
                question = getResources().getStringArray(R.array.basic_QuestionSet5);
                option_a = getResources().getStringArray(R.array.option_a4);
                option_b = getResources().getStringArray(R.array.option_b4);
                option_c = getResources().getStringArray(R.array.option_c4);
                option_d = getResources().getStringArray(R.array.option_d4);
                answer = getResources().getStringArray(R.array.answer_set5);
                for (int i = 0; i < 40; i++) {
                    list.add(new Question_model(question[i], option_a[i], option_b[i], option_c[i], option_d[i], answer[i]));
                }
                break;
